...
> 修复日期：2026-06-29 · 验收：`python scripts/validate_pipeline.py` 99/99 PASSED
...
| [L79.md](per_lesson/L79.md) | 音乐嵌入向量（embedding）— 对比学习（contrastive learning）：相似风格靠近，不同 | A- |
...
| [L99.md](per_lesson/L99.md) | Aurora v2 与持续成长——6 个月之后怎么走 | A- |